...
async function buttonStuff() {
    ...
    if ((offer != "") && (username != "")) {
        ...
        let heldElement = document.createElement("h1")
        heldElement.textContent = "Sent! You should recieve a response soon, otherwise send a followup."
        let body = document.getElementById("main")
        body.appendChild(heldElement)
        alert("Sent! You should recieve a response soon, otherwise send a followup.")
